...
case_tools_server = create_sdk_mcp_server(
    name="case_tools",
    tools=[record_eligibility, add_checklist_item, add_notification_tool],
)

# create_sdk_mcp_server ile tanımlanan tool'lara SDK içinde bu isimle erişilir:
# mcp__case_tools__record_eligibility, mcp__case_tools__add_checklist_item, mcp__case_tools__add_notification
